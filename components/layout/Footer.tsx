  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-100 pt-20 pb-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" aria-label="Follow us on Twitter" className="text-gray-600 hover:text-blue-600 transition-colors"><Twitter className="w-5 h-5" /></a>
              <a href="#" aria-label="Visit our GitHub" className="text-gray-600 hover:text-blue-600 transition-colors"><Github className="w-5 h-5" /></a>
              <a href="#" aria-label="Connect on LinkedIn" className="text-gray-600 hover:text-blue-600 transition-colors"><Linkedin className="w-5 h-5" /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#" className="text-gray-700 hover:text-blue-600 transition-colors">Latest Articles</a></li>
              <li><a href="#" className="text-gray-700 hover:text-blue-600 transition-colors">Popular Topics</a></li>
              <li><a href="#" className="text-gray-700 hover:text-blue-600 transition-colors">Authors</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><a href="#" className="text-gray-700 hover:text-blue-600 transition-colors">Support</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-sm font-bold text-gray-900 uppercase tracking-widest mb-6">Subscribe</h4>
            <p className="text-gray-700 text-sm mb-4">Get the latest insights directly in your inbox.</p>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600 font-medium">
